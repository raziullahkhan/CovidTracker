...
public class CoronaStateAdapter extends ArrayAdapter<CoronaState> {
    public CoronaStateAdapter(@NonNull Context context, ArrayList<CoronaState> coronaState) {
        super(context,0,coronaState);
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        CoronaState corona=getItem(position);
        TextView tvRegion=(TextView)listItem.findViewById(R.id.tvRegion);
        tvRegion.setText(corona.getState());
